        ...
        >
          ...
          <div data-thq="thq-navbar-nav" className="home-desktop-menu">
            <nav className="home-links">
              ...
              <span className="home-nav2 bodySmall">Downloads</span>
              <span className="home-nav3 bodySmall">Support</span>
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links1">
                <span>Home</span>
                <span className="home-nav21 bodySmall">Downloads</span>
                <span className="home-nav31 bodySmall">Support</span>
        ...
        <footer className="footerContainer home-footer1">
          <div className="home-container31">
            ...
            <nav className="home-nav1 bodySmall home-nav1">
              ...
              <span className="home-nav22 bodySmall">Downloads</span>
